...
namespace SecurityLibrary.DES
{
    ...
    public class DES : CryptographicTechnique
    {
        ...
        public override string Decrypt(string cipherText, string key)
        {
            ...
            // Permutate The CipherText And Create The L16 And R16
            cipherText = Permutate(cipherText, IP);
            L = cipherText.Substring(0, 32);
            R = cipherText.Substring(32);
            ...
            string PlainText = Permutate(R + L, P_1);
            PlainText = ToHexa(PlainText);
            return "0x" + PlainText;
        }
